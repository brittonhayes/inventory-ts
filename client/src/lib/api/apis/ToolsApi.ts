...
import type { CreateToolDto, ToolResponse, UpdateToolDto } from '../models';
import {
...
export class ToolsApi extends runtime.BaseAPI {
	/**
	 */
	async toolsControllerCreateRaw(
		requestParameters: ToolsControllerCreateRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<ToolResponse>> {
		if (requestParameters.createToolDto === null || requestParameters.createToolDto === undefined) {
			throw new runtime.RequiredError(
				'createToolDto',
				'Required parameter requestParameters.createToolDto was null or undefined when calling toolsControllerCreate.'
			);
		}
	...
	/**
	 */
	async toolsControllerDeleteRaw(
		requestParameters: ToolsControllerDeleteRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<ToolResponse>> {
		if (requestParameters.id === null || requestParameters.id === undefined) {
			throw new runtime.RequiredError(
				'id',
				'Required parameter requestParameters.id was null or undefined when calling toolsControllerDelete.'
			);
		}
	...
	/**
	 */
	async toolsControllerFindByIdRaw(
		requestParameters: ToolsControllerFindByIdRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<ToolResponse>> {
		if (requestParameters.id === null || requestParameters.id === undefined) {
			throw new runtime.RequiredError(
				'id',
				'Required parameter requestParameters.id was null or undefined when calling toolsControllerFindById.'
			);
		}
	...
	/**
	 */
	async toolsControllerListRaw(
		requestParameters: ToolsControllerListRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	...
	/**
	 */
	async toolsControllerUpdateRaw(
		requestParameters: ToolsControllerUpdateRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<ToolResponse>> {
		if (requestParameters.id === null || requestParameters.id === undefined) {
			throw new runtime.RequiredError(
				'id',
				'Required parameter requestParameters.id was null or undefined when calling toolsControllerUpdate.'
			);
		}
		...
		if (requestParameters.updateToolDto === null || requestParameters.updateToolDto === undefined) {
			throw new runtime.RequiredError(
				'updateToolDto',
				'Required parameter requestParameters.updateToolDto was null or undefined when calling toolsControllerUpdate.'
			);
		}
...
export type ToolsControllerListOrderByEnum =
	typeof ToolsControllerListOrderByEnum[keyof typeof ToolsControllerListOrderByEnum];
/**
 * @export
 */
