...
import type { CreateEquipmentDto, EquipmentResponse, UpdateEquipmentDto } from '../models';
import {
...
export class EquipmentApi extends runtime.BaseAPI {
	/**
	 */
	async equipmentControllerCreateRaw(
		requestParameters: EquipmentControllerCreateRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<EquipmentResponse>> {
		if (requestParameters.createEquipmentDto === null || requestParameters.createEquipmentDto === undefined) {
			throw new runtime.RequiredError(
				'createEquipmentDto',
				'Required parameter requestParameters.createEquipmentDto was null or undefined when calling equipmentControllerCreate.'
			);
		}
	...
	/**
	 */
	async equipmentControllerCreate(
		requestParameters: EquipmentControllerCreateRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	...
	/**
	 */
	async equipmentControllerDeleteRaw(
		requestParameters: EquipmentControllerDeleteRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<EquipmentResponse>> {
		if (requestParameters.id === null || requestParameters.id === undefined) {
			throw new runtime.RequiredError(
				'id',
				'Required parameter requestParameters.id was null or undefined when calling equipmentControllerDelete.'
			);
		}
	...
	/**
	 */
	async equipmentControllerDelete(
		requestParameters: EquipmentControllerDeleteRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<EquipmentResponse> {
	...
	/**
	 */
	async equipmentControllerFindByIdRaw(
		requestParameters: EquipmentControllerFindByIdRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<EquipmentResponse>> {
		if (requestParameters.id === null || requestParameters.id === undefined) {
			throw new runtime.RequiredError(
				'id',
				'Required parameter requestParameters.id was null or undefined when calling equipmentControllerFindById.'
			);
		}
	...
	/**
	 */
	async equipmentControllerFindById(
		requestParameters: EquipmentControllerFindByIdRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<EquipmentResponse> {
	...
	/**
	 */
	async equipmentControllerListRaw(
		requestParameters: EquipmentControllerListRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	...
	/**
	 */
	async equipmentControllerUpdateRaw(
		requestParameters: EquipmentControllerUpdateRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<runtime.ApiResponse<EquipmentResponse>> {
		if (requestParameters.id === null || requestParameters.id === undefined) {
			throw new runtime.RequiredError(
				'id',
				'Required parameter requestParameters.id was null or undefined when calling equipmentControllerUpdate.'
			);
		}
		...
		if (requestParameters.updateEquipmentDto === null || requestParameters.updateEquipmentDto === undefined) {
			throw new runtime.RequiredError(
				'updateEquipmentDto',
				'Required parameter requestParameters.updateEquipmentDto was null or undefined when calling equipmentControllerUpdate.'
			);
		}
	...
	/**
	 */
	async equipmentControllerUpdate(
		requestParameters: EquipmentControllerUpdateRequest,
		initOverrides?: RequestInit | runtime.InitOverrideFunction
	): Promise<EquipmentResponse> {
...
export type EquipmentControllerListOrderByEnum =
	typeof EquipmentControllerListOrderByEnum[keyof typeof EquipmentControllerListOrderByEnum];
/**
 * @export
 */
...
export type EquipmentControllerListSortEnum =
	typeof EquipmentControllerListSortEnum[keyof typeof EquipmentControllerListSortEnum];
